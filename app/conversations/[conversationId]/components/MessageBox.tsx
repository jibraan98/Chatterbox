    ...
    <div className={container}>
        ...
        <div className={body}>
            ...
            <div className={message}>
                ...
                {data.image ? (<Image onClick={() => setImageModalOpen(true)} alt='Image' height="288" width="288" src={data.image} className='object-cover cursor-pointer hover:scale-110 transition translate'/>) 
                : 
                (<div>{data.body}</div>)
                }
            </div>
